...
GitHub source control and Railway application/PostgreSQL hosting. Recorded September 6, 2026. Batch 8 (v0.8.0, schema 9) passed full local verification, both exact-commit PostgreSQL CI runs, Railway staging, and the complete remote workflow. Railway production and all 52 exact-commit public checks passed on the same release.

## Current infrastructure

Source: [GreenShoeGarage/Oracle](https://github.com/GreenShoeGarage/Oracle). Checked release commit: `ef3d822c0e6a36fd0f1e3081b68f5d750d268106` (v0.8.0, schema version 9).
