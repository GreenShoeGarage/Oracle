...
GitHub source control and Railway application/PostgreSQL hosting. Recorded September 6, 2026. Batch 9 (v0.9.0, schema 10) is implemented and its complete local all-twelve/all-three-theme rehearsal passed. Exact-candidate GitHub/PostgreSQL, Railway staging/remote acceptance, and production gates remain pending. The currently verified live infrastructure below still records Batch 8.

## Current infrastructure

Source: [GreenShoeGarage/Oracle](https://github.com/GreenShoeGarage/Oracle). Last verified deployed release commit: `ef3d822c0e6a36fd0f1e3081b68f5d750d268106` (v0.8.0, schema version 9).

Staging deployment `e8817d54-0bb8-458e-b862-cdf194e614bb` succeeded at this commit, and [staging CI 34009469442](https://github.com/GreenShoeGarage/Oracle/actions/runs/34009469442) passed the complete remote workflow. Production deployment `19c6b417-2e9d-4e74-9dc3-c7bc1ff34ec3` succeeded on the same commit. [Production CI 34009665773](https://github.com/GreenShoeGarage/Oracle/actions/runs/34009665773) passed exact-commit v0.8.0/schema 9 readiness and all 52 public GET checks without creating data. Exact run links and evidence are in [STATUS.md](STATUS.md).

| Target | Railway project | Project ID | Application URL | Status |
| --- | --- | --- | --- | --- |
| Staging | ORACLE Staging | `4e75d5ec-f8e9-492d-ae75-e0d44428d24a` | [Staging app](https://oracle-production-488d.up.railway.app) | v0.8.0/schema 9 deployed; complete SIGIL/STATIC/three-theme workflow passed |
| Production | ORACLE | `d1989864-9a40-4176-a9d3-203a06c4bd72` | [Production app](https://oracle.greenshoegarage.com) | v0.8.0/schema 9 live; all 52 exact-commit public checks passed |
...
Focused HTTP/browser checks and eight full-app DOM/API checks passed with zero uncaught errors. Full local verification passed 242 tests (230 passed, zero failures, 12 deliberate TCP-only skips). Exact-candidate GitHub CI, twelve real TCP gates (the existing eight plus four operations races), populated schema-10 recovery, startup/Docker, Railway staging acceptance, and the independent production public gate remain pending. Record the exact source SHA and release evidence before promotion.
...
Current production state (Batch 8): the reserved operator account is enabled. Migration and startup logs confirmed the matching existing account at this release; provisioning preserved its identity and password. No replacement user was created. The conditional instructions below remain the supported process for new installations or absent reserved accounts.
