...
GitHub source control and Railway application/PostgreSQL hosting. Recorded September 6, 2026. Batch 7 (v0.7.0, schema 8) passed local verification, both exact-candidate PostgreSQL CI runs, Railway staging, and the complete remote workflow. Railway production and all 43 exact-commit public checks passed on the same release.
