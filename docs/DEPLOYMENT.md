...
GitHub source control and Railway application/PostgreSQL hosting. Recorded September 5, 2026. Batch 3 (application v0.3.0, schema 4) is deployed after successful CI, the complete remote two-player staging workflow, and exact-commit production checks. Configure each service before its first source-backed deployment.

## Current infrastructure

Source: [GreenShoeGarage/Oracle](https://github.com/GreenShoeGarage/Oracle). Release commit: `12a34458de3bdbe0968e7d2b174ba441e7952d09` (v0.3.0, schema version 4).
