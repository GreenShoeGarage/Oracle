...
const workerSource = await readFile("public/sw-v16.js", "utf8");
assert.ok(workerSource.includes(`const VERSION='${VERSION}';`), "The v1.6 cached public shell must match the server version.");
assert.ok((await readFile("public/install-v16.js", "utf8")).includes(`export const SHELL_VERSION = '${VERSION}';`), "The v1.6 install controller must identify this shell version.");
for (const asset of ["/landing.css","/display.js","/startup.js","/preparation-model.js","/app.js","/app-v15.js","/app-v14.js","/app-v13.js","/app-core.js","/install.js","/connections.html","/connections.js","/connections.css","/arcs.html","/arcs.js","/arcs-store.js","/arcs.css","/projects.html","/projects.js","/projects.css","/project-effects-ui.js"]) {
...
for (const file of ["public/projects.html","public/projects-ui.js","public/projects.css","public/project-effects-ui.js","public/app-v16.js","public/sw-v16.js","public/install-v16.js","src/projects-app.js","src/project-effects-app.js","src/project-starters.js","src/app-v16.js","migrations/013_community_projects.sql","migrations/014_project_effects.sql"]) await readFile(file);
const migration = await readFile("migrations/014_project_effects.sql", "utf8");
...
console.log("Syntax, version, entrypoint, Batch 16, and offline-shell assets verified.");
