...
const workerSource = await readFile("public/sw-v18.js", "utf8");
assert.ok(workerSource.includes(`const VERSION='${VERSION}';`), "The v1.8 cached public shell must match the server version.");
assert.ok((await readFile("public/install-v18.js", "utf8")).includes(`export const SHELL_VERSION = '${VERSION}';`), "The v1.8 install controller must identify this shell version.");
for (const asset of ["/landing.css","/display.js","/startup.js","/preparation-model.js","/app.js","/app-v17.js","/app-v16.js","/app-v15.js","/app-v14.js","/app-v13.js","/app-core.js","/install.js","/connections.html","/connections.js","/connections.css","/arcs.html","/arcs.js","/arcs-store.js","/arcs.css","/projects.html","/projects.js","/projects.css","/project-effects-ui.js","/experiences.html","/experiences.js","/experiences.css","/field-home.html","/field-home.js","/field-home.css"]) {
...
for (const file of [
  ...
  "public/experiences.html","public/experiences-ui.js","public/experiences.css","public/starter-experiences.html","public/field-home.html","public/field-home.js","public/field-home.css","public/app-v18.js","src/app-v18.js","public/app-v17.js",
  "public/sw-v18.js","public/install-v18.js",
...
console.log("Syntax, version, entrypoint, Batch 18, and offline-shell assets verified.");
