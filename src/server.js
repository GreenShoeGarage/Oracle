...
import { createAppV19 } from "./app-v19.js";
...
try {
  ...
  const server = createServer({ requestTimeout: 30000, headersTimeout: 10000, maxHeaderSize: 16384 }, createAppV19({ pool, config, logger: (entry) => console.log(JSON.stringify(entry)) }));
