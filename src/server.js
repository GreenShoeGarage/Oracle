...
try {
  ...
  const server = createServer({ requestTimeout: 30000, headersTimeout: 10000, maxHeaderSize: 16384 }, createAppV17({ pool, config, logger: (entry) => console.log(JSON.stringify(entry)) }));
